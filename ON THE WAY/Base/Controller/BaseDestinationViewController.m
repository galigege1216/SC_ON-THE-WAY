//
//  BaseDestinationViewController.m
//  ON THE WAY
//
...
@interface BaseDestinationViewController ()<UITableViewDataSource,UITableViewDelegate>


@end

@implementation BaseDestinationViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (![button_text isKindOfClass:[NSNull class]]) {
        ...
        //按钮颜色
        UIColor *color = [UIColor colorWithRed:196/255.0 green:206/255.0 blue:206/255.0 alpha:0.5];
